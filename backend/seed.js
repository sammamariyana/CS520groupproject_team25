...
async function seed() {
  ...
  const roommateData = [
    ...
    { sleep: 'flexible',    cleanliness: 2, noise: 4, smoking: false, pets: false, guests: 'often',        study: 'cafe',    hobbies: ['cooking', 'yoga', 'gaming'],'bio': 'Comm major, laid-back, often has friends over on weekends.', budget: '$600–$800', moveIn: '2026-09-01' },
  ]

  const roommateProfiles = roommateData.map((data, i) => ({
    id: randomUUID(), createdAt: now(),
